# MailShield Security Intelligence — Gmail Ingestion & OAuth Integration Guide

## 1. Overview

This document defines the architecture, privacy boundaries, token handling, and configuration for the **Defensive Live Gmail Ingestion Security Connector** in **MailShield Security Intelligence**.

---

## 2. OAuth Architecture & Minimal Permissions

MailShield is a **passive email forensic intelligence platform**. It never modifies, deletes, or sends emails.
...
2. Create a new Project or select an existing project (e.g. `mailshield-security-intelligence`).
...
4. Configure the **OAuth Consent Screen**:
   ...
   * App name: `MailShield Security Intelligence`.
   * Add Scope: `https://www.googleapis.com/auth/gmail.readonly`.
   * Add your Google account as a Test User.
5. Create **OAuth 2.0 Client ID Credentials**:
   * Application type: `Web application`.
   * Name: `MailShield Security NextAuth Client`.
